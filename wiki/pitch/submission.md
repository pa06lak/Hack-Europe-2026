---
title: "Submission — checklist & deadline"
type: pitch
status: working
...
## Ship timeline (work back from 19:00)

| When | Do |
|---|---|
| **~17:30** | 🛑 Stop building. Whatever works, works — freeze it. → `[[timeline]]` |
| **17:30–18:00** | 🎥 Record the 2-min video (explanation + live walkthrough of the one happy path) → `[[demo]]` |
| **18:00–18:30** | 🧹 Polish repo + README; confirm SLNG + Attio + n8n + Gemini are documented → `[[stack]]`, `[[partners]]` |
| **18:30** | 📨 Fill the submission form + **submit** |
| **18:30–19:00** | ⏳ 30-min buffer — re-upload, fix links, breathe |

🤔 **assumption:** stopping at 17:30 leaves enough runway. If the build slips, the demo path is sacred — cut scope, not the video. → `[[rules]]`, `[[demo]]`

## TODO placeholders

- ❓ open: **Submission form link** = `<fill in>` — get from organisers / Discord.
- 💡 Discord (links, form, announcements): https://discord.gg/brSqTjJVdh
